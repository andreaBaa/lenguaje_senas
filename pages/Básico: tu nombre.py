...
opciones_correctas = False  # Cambiar esto según la lógica de tu aplicación

if opciones_correctas:
    publish.single("esp32/led", "green", hostname="IP_de_tu_servidor_ESP32")
else:
    publish.single("esp32/led", "red", hostname="IP_de_tu_servidor_ESP32")
