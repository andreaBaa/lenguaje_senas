...
import os 
import random 
import paho.mqtt.publish as publish  # Importa la biblioteca MQTT
...
if nombre: 
    if st.button("Verificar"): 
        ...
        # Envía las respuestas seleccionadas por el usuario al dispositivo ESP32 a través de MQTT
        topic = "Suiche1"
        payload = {"respuesta": opciones_seleccionadas}
        publish.single(topic, payload=str(payload), hostname="157.230.214.127")
