...
if nombre: 
    if st.button("Verificar"): 
        # Crear un diccionario con las opciones seleccionadas
        opciones_json = json.dumps(opciones_seleccionadas)
        # Publicar el mensaje MQTT con las opciones seleccionadas
        client1.publish("opciones_seleccionadas", opciones_json)
